...
# Сборка GULP от dyakonovr<br>версия для одностраничных сайтов
## Начало работы

Для работы с данной сборкой в новом проекте, склонируйте все содержимое репозитория <br>
`git clone <this repo>`
Затем, находясь в корне проекта, запустите команду `npm i`, которая установит все находящиеся в package.json зависимости.
После этого вы можете использовать любую из предложенных команд сборки (итоговые файлы попадают в папку __dist__ корневой директории): <br>
...
Стили, написанные в __components__, следует подключать в файл __index.scss__ .
...
В итоговой папке __app/css__ создаётся файл __index.min.css__.
